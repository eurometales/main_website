...
export const productSections: ProductSection[] = [
  {
    ...
    categories: [
      ...
      },
      {
        ...
        imageKey: "img-06",
        subcategories: [
          { id: "chapa-caliente", name: "Chapa laminada en caliente", description: "Utilizada en construcción, automóviles, tubos y cilindros de gas.", imageKey: "img-07", extras: "Corte | Granallado y Pintado | Cizalla y Plegado" },
          { id: "chapa-decapada", name: "Chapa decapada", description: "Buenas propiedades de maleabilidad y ductilidad. Usada en automoción y mecánica.", imageKey: "img-08", extras: "Corte" },
          { id: "chapa-estriada", name: "Chapa estriada", description: "Relieve de estrías ideal para evitar deslizamientos en entornos secos y húmedos.", imageKey: "img-09", extras: "Corte" },
          { id: "chapa-lagrimada", name: "Chapa lagrimada", description: "Superficie con formas de lágrimas, antideslizante y resistente a impactos.", imageKey: "img-10", extras: "Corte" },
          { id: "chapa-corten", name: "Chapa corten", description: "Alto contenido en cobre, cromo y níquel. Tonalidad rojiza con protección natural.", imageKey: "img-11", extras: "Corte" },
          { id: "chapa-galvanizada", name: "Chapa galvanizada", description: "Tratamiento de protección frente a corrosión y oxidación.", imageKey: "img-12", extras: "Corte" },
          { id: "chapa-prelacada", name: "Chapa prelacada", description: "Disponible en distintos colores: blanco pirineo, rojo teja, verde navarra y más.", imageKey: "img-13", extras: "Corte" },
          { id: "chapa-frio", name: "Chapa laminada en frío", description: "Versátil, empleada en automoción, muebles metálicos y electrodomésticos.", imageKey: "img-14", extras: "Corte | Cizalla y Plegado" },
          { id: "chapa-industrial", name: "Chapa industrial", description: "Utilizada en construcción y sector naval, obtenida por deformación termomecánica.", imageKey: "img-15", extras: "Corte" },
          { id: "chapa-antidesgaste", name: "Chapa antidesgaste", description: "Indicada para situaciones de gran resistencia a la abrasión.", imageKey: "img-16", extras: "Corte" },
          { id: "placa-anclaje", name: "Placa de anclaje", description: "Planchas de acero para construcción, junto a perfiles estructurales. Cortadas a medida.", imageKey: "img-17", extras: "Corte" },
        ],
      },
      {
        id: "tubos",
        ...
        subcategories: [
          ...
          { id: "perfil-carpinteria", name: "Perfil de carpintería", description: "Para puertas y ventanas. Disponible en decapado y galvanizado. EN 10305.", imageKey: "img-24", extras: "Corte" },
          {
      ...
      },
      {
        ...
        imageKey: "img-26",
        subcategories: [
          { id: "corrugado-barras", name: "Acero corrugado", description: "Barras corrugadas B400SD y B500SD según UNE36065:11. En barras de 6 o 12 m y rollos.", extras: "Corte" },
          { id: "grafil", name: "Grafil", description: "Alambre corrugado de acero B500T, alta resistencia y durabilidad.", extras: "Corte" },
          {
            id: "malla",
          ...
          { id: "celosia", name: "Armadura en celosía", description: "Formada por elementos superior, inferiores y de conexión en zig-zag. Formatos de 6,0 m y 12,80 m.", extras: "Corte" },
        ],
      },
      {
        id: "acero-activo",
        ...
        subcategories: [
          { id: "alambre-pretensado", name: "Alambre pretensado", description: "Acero alto carbono y baja relajación para hormigón pretensado. Bobinas de 1.250 kg o 2.500 kg.", extras: "Corte" },
          { id: "cordon", name: "Cordón", description: "Seis alambres exteriores trenzados alrededor del alambre central. Bobinas de 3.200 kg o 4.000 kg.", extras: "Corte" },
        ],
      },
      {
        id: "complementarios",
        ...
        subcategories: [
          { id: "alambre", name: "Alambre", description: "Galvanizado, gris, plastificado y recocido. Todos los diámetros." },
          { id: "soldadura", name: "Soldadura", description: "Alambres SG2 (0,8/1,0/1,2 mm), electrodos rutilo (2,5/3,2), discos de corte y desbaste." },
          { id: "otros", name: "Otros productos", description: "Puntas de cabeza plana, curvas de soldar, materiales de pintura, tubos invernadero y más." },
        ],
      },
    ],
  },
